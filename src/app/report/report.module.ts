...
@NgModule({
  declarations: [AllreportComponent, AllEmpReportComponent, AllPurchasereportComponent, AllSalesreportComponent, AllFinancereportComponent, AllStockreportComponent],
  imports: [
    FormsModule,
    MatFormFieldModule,
    MatInputModule,
